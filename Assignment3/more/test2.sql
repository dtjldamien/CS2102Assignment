...
CREATE VIEW zzanswer AS SELECT * FROM v2;
CREATE VIEW zzsolution AS SELECT * FROM zzdb1q2;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v2;
CREATE VIEW zzsolution AS SELECT * FROM zzdb2q2;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v2;
CREATE VIEW zzsolution AS SELECT * FROM zzdb3q2;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v2;
CREATE VIEW zzsolution AS SELECT * FROM zzdb4q2;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v2;
CREATE VIEW zzsolution AS SELECT * FROM zzdb5q2;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v2;
CREATE VIEW zzsolution AS SELECT * FROM zzdb6q2;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v2;
CREATE VIEW zzsolution AS SELECT * FROM zzdb7q2;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v2;
CREATE VIEW zzsolution AS SELECT * FROM zzdb8q2;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v2;
CREATE VIEW zzsolution AS SELECT * FROM zzdb9q2;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v2;
CREATE VIEW zzsolution AS SELECT * FROM zzdb10q2;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v2;
CREATE VIEW zzsolution AS SELECT * FROM zzdb11q2;

-- Compare zzsolution and zzanswer for Question 2 on testcase 11
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v2;
CREATE VIEW zzsolution AS SELECT * FROM zzdb12q2;

-- Compare zzsolution and zzanswer for Question 2 on testcase 12
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v2;
CREATE VIEW zzsolution AS SELECT * FROM zzdb13q2;

-- Compare zzsolution and zzanswer for Question 2 on testcase 13
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v2;
CREATE VIEW zzsolution AS SELECT * FROM zzdb14q2;

-- Compare zzsolution and zzanswer for Question 2 on testcase 14
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v2;
CREATE VIEW zzsolution AS SELECT * FROM zzdb15q2;

-- Compare zzsolution and zzanswer for Question 2 on testcase 15
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v2;
CREATE VIEW zzsolution AS SELECT * FROM zzdb16q2;

-- Compare zzsolution and zzanswer for Question 2 on testcase 16
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v2;
CREATE VIEW zzsolution AS SELECT * FROM zzdb17q2;

-- Compare zzsolution and zzanswer for Question 2 on testcase 17
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v2;
CREATE VIEW zzsolution AS SELECT * FROM zzdb18q2;

-- Compare zzsolution and zzanswer for Question 2 on testcase 18
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v2;
CREATE VIEW zzsolution AS SELECT * FROM zzdb19q2;

-- Compare zzsolution and zzanswer for Question 2 on testcase 19
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v2;
CREATE VIEW zzsolution AS SELECT * FROM zzdb20q2;

-- Compare zzsolution and zzanswer for Question 2 on testcase 20
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
