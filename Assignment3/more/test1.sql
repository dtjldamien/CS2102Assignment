...
CREATE VIEW zzanswer AS SELECT * FROM v1;
CREATE VIEW zzsolution AS SELECT * FROM zzdb1q1;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v1;
CREATE VIEW zzsolution AS SELECT * FROM zzdb2q1;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v1;
CREATE VIEW zzsolution AS SELECT * FROM zzdb3q1;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v1;
CREATE VIEW zzsolution AS SELECT * FROM zzdb4q1;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v1;
CREATE VIEW zzsolution AS SELECT * FROM zzdb5q1;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v1;
CREATE VIEW zzsolution AS SELECT * FROM zzdb6q1;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v1;
CREATE VIEW zzsolution AS SELECT * FROM zzdb7q1;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v1;
CREATE VIEW zzsolution AS SELECT * FROM zzdb8q1;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v1;
CREATE VIEW zzsolution AS SELECT * FROM zzdb9q1;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v1;
CREATE VIEW zzsolution AS SELECT * FROM zzdb10q1;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v1;
CREATE VIEW zzsolution AS SELECT * FROM zzdb11q1;

-- Compare zzsolution and zzanswer for Question 1 on testcase 11
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v1;
CREATE VIEW zzsolution AS SELECT * FROM zzdb12q1;

-- Compare zzsolution and zzanswer for Question 1 on testcase 12
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v1;
CREATE VIEW zzsolution AS SELECT * FROM zzdb13q1;

-- Compare zzsolution and zzanswer for Question 1 on testcase 13
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v1;
CREATE VIEW zzsolution AS SELECT * FROM zzdb14q1;

-- Compare zzsolution and zzanswer for Question 1 on testcase 14
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v1;
CREATE VIEW zzsolution AS SELECT * FROM zzdb15q1;

-- Compare zzsolution and zzanswer for Question 1 on testcase 15
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v1;
CREATE VIEW zzsolution AS SELECT * FROM zzdb16q1;

-- Compare zzsolution and zzanswer for Question 1 on testcase 16
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v1;
CREATE VIEW zzsolution AS SELECT * FROM zzdb17q1;

-- Compare zzsolution and zzanswer for Question 1 on testcase 17
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v1;
CREATE VIEW zzsolution AS SELECT * FROM zzdb18q1;

-- Compare zzsolution and zzanswer for Question 1 on testcase 18
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v1;
CREATE VIEW zzsolution AS SELECT * FROM zzdb19q1;

-- Compare zzsolution and zzanswer for Question 1 on testcase 19
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v1;
CREATE VIEW zzsolution AS SELECT * FROM zzdb20q1;

-- Compare zzsolution and zzanswer for Question 1 on testcase 20
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
