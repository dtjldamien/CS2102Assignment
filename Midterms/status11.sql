-- Test summary for Query for Question 11
...
CREATE VIEW zzanswer AS SELECT * FROM v11;
CREATE VIEW zzsolution AS SELECT * FROM zzdb1q11;

-- Compare zzsolution and zzanswer for Question 11 on testcase 1
WITH correct AS  ( 
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v11;
CREATE VIEW zzsolution AS SELECT * FROM zzdb2q11;

-- Compare zzsolution and zzanswer for Question 11 on testcase 2
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v11;
CREATE VIEW zzsolution AS SELECT * FROM zzdb3q11;

-- Compare zzsolution and zzanswer for Question 11 on testcase 3
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v11;
CREATE VIEW zzsolution AS SELECT * FROM zzdb4q11;

-- Compare zzsolution and zzanswer for Question 11 on testcase 4
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
SELECT status AS  "Summary of testing query 11"  FROM zzSummary;
