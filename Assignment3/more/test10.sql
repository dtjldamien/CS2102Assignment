...
CREATE VIEW zzanswer AS SELECT * FROM v10;
CREATE VIEW zzsolution AS SELECT * FROM zzdb1q10;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v10;
CREATE VIEW zzsolution AS SELECT * FROM zzdb2q10;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v10;
CREATE VIEW zzsolution AS SELECT * FROM zzdb3q10;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v10;
CREATE VIEW zzsolution AS SELECT * FROM zzdb4q10;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v10;
CREATE VIEW zzsolution AS SELECT * FROM zzdb5q10;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v10;
CREATE VIEW zzsolution AS SELECT * FROM zzdb6q10;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v10;
CREATE VIEW zzsolution AS SELECT * FROM zzdb7q10;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v10;
CREATE VIEW zzsolution AS SELECT * FROM zzdb8q10;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v10;
CREATE VIEW zzsolution AS SELECT * FROM zzdb9q10;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v10;
CREATE VIEW zzsolution AS SELECT * FROM zzdb10q10;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v10;
CREATE VIEW zzsolution AS SELECT * FROM zzdb11q10;

-- Compare zzsolution and zzanswer for Question 10 on testcase 11
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v10;
CREATE VIEW zzsolution AS SELECT * FROM zzdb12q10;

-- Compare zzsolution and zzanswer for Question 10 on testcase 12
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v10;
CREATE VIEW zzsolution AS SELECT * FROM zzdb13q10;

-- Compare zzsolution and zzanswer for Question 10 on testcase 13
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v10;
CREATE VIEW zzsolution AS SELECT * FROM zzdb14q10;

-- Compare zzsolution and zzanswer for Question 10 on testcase 14
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v10;
CREATE VIEW zzsolution AS SELECT * FROM zzdb15q10;

-- Compare zzsolution and zzanswer for Question 10 on testcase 15
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v10;
CREATE VIEW zzsolution AS SELECT * FROM zzdb16q10;

-- Compare zzsolution and zzanswer for Question 10 on testcase 16
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v10;
CREATE VIEW zzsolution AS SELECT * FROM zzdb17q10;

-- Compare zzsolution and zzanswer for Question 10 on testcase 17
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v10;
CREATE VIEW zzsolution AS SELECT * FROM zzdb18q10;

-- Compare zzsolution and zzanswer for Question 10 on testcase 18
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v10;
CREATE VIEW zzsolution AS SELECT * FROM zzdb19q10;

-- Compare zzsolution and zzanswer for Question 10 on testcase 19
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v10;
CREATE VIEW zzsolution AS SELECT * FROM zzdb20q10;

-- Compare zzsolution and zzanswer for Question 10 on testcase 20
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
