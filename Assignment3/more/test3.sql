...
CREATE VIEW zzanswer AS SELECT * FROM v3;
CREATE VIEW zzsolution AS SELECT * FROM zzdb1q3;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v3;
CREATE VIEW zzsolution AS SELECT * FROM zzdb2q3;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v3;
CREATE VIEW zzsolution AS SELECT * FROM zzdb3q3;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v3;
CREATE VIEW zzsolution AS SELECT * FROM zzdb4q3;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v3;
CREATE VIEW zzsolution AS SELECT * FROM zzdb5q3;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v3;
CREATE VIEW zzsolution AS SELECT * FROM zzdb6q3;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v3;
CREATE VIEW zzsolution AS SELECT * FROM zzdb7q3;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v3;
CREATE VIEW zzsolution AS SELECT * FROM zzdb8q3;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v3;
CREATE VIEW zzsolution AS SELECT * FROM zzdb9q3;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v3;
CREATE VIEW zzsolution AS SELECT * FROM zzdb10q3;
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v3;
CREATE VIEW zzsolution AS SELECT * FROM zzdb11q3;

-- Compare zzsolution and zzanswer for Question 3 on testcase 11
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v3;
CREATE VIEW zzsolution AS SELECT * FROM zzdb12q3;

-- Compare zzsolution and zzanswer for Question 3 on testcase 12
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v3;
CREATE VIEW zzsolution AS SELECT * FROM zzdb13q3;

-- Compare zzsolution and zzanswer for Question 3 on testcase 13
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v3;
CREATE VIEW zzsolution AS SELECT * FROM zzdb14q3;

-- Compare zzsolution and zzanswer for Question 3 on testcase 14
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v3;
CREATE VIEW zzsolution AS SELECT * FROM zzdb15q3;

-- Compare zzsolution and zzanswer for Question 3 on testcase 15
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v3;
CREATE VIEW zzsolution AS SELECT * FROM zzdb16q3;

-- Compare zzsolution and zzanswer for Question 3 on testcase 16
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v3;
CREATE VIEW zzsolution AS SELECT * FROM zzdb17q3;

-- Compare zzsolution and zzanswer for Question 3 on testcase 17
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v3;
CREATE VIEW zzsolution AS SELECT * FROM zzdb18q3;

-- Compare zzsolution and zzanswer for Question 3 on testcase 18
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v3;
CREATE VIEW zzsolution AS SELECT * FROM zzdb19q3;

-- Compare zzsolution and zzanswer for Question 3 on testcase 19
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
...
DROP VIEW IF EXISTS zzanswer, zzsolution;
CREATE VIEW zzanswer AS SELECT * FROM v3;
CREATE VIEW zzsolution AS SELECT * FROM zzdb20q3;

-- Compare zzsolution and zzanswer for Question 3 on testcase 20
WITH correct AS  ( 
	SELECT * FROM zzanswer 
	INTERSECT ALL 
	SELECT * FROM zzsolution
